    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class="col-md-6 ">
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="<?php echo "assets/images/blog-images/" . $blog_img ?>" class="img-fluid rounded-start"
                            alt="<?php echo $blog_id; ?>">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $blog_title; ?> </h5>
                            <p class="card-text"><?php $blog_desc; ?></p>
                            <p class="card-text"><small
                                    class="text-body-secondary"><?php echo $blog_date_created; ?></small>
                            </p>
                        </div>
                    </div>
                </div>
